        ...
        <form method="POST" action="{{ route('public.warranty.store', $label->serial) }}">
            ...
            <div class="row-2">
                <div class="form-group">
                    ...
                    <input type="text" id="province" name="province" class="form-control" value="{{ old('province') }}" maxlength="100" required>
                    @error('province') <div class="form-error">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="city">Ciudad *</label>
                    <input type="text" id="city" name="city" class="form-control" value="{{ old('city') }}" maxlength="100" required>
